                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 mb-4">
                    <div className="relative">
                      <div className="p-3 sm:p-4 bg-gradient-corporate rounded-full shadow-glow">
                        <Building2 className="h-10 w-10 sm:h-12 sm:w-12 text-prestige-amber group-hover:animate-spin-3s" />
                      </div>
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-accent group-hover:text-prestige-amber transition-colors text-center sm:text-left">
                      Banking Portal
                    </h3>
                  </div>
                  <p className="text-muted-foreground mb-4 text-xs sm:text-sm text-center sm:text-left">
