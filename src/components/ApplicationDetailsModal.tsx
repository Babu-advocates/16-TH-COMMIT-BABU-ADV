        ...
        <ScrollArea className="max-h-[calc(90vh-120px)]">
          {loading ? <div className="flex justify-center py-8">
              ...
              <Card>
                ...
                <CardContent className="grid grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">Salesman Name</label>
                    <p className="font-semibold">{application.salesman_name || 'Not specified'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">Salesman Contact No</label>
                    <div className="flex items-center space-x-2">
                  ...
                  <div className="col-span-2">
                    <label className="text-sm font-medium text-muted-foreground">Salesman Email</label>
                    <div className="flex items-center space-x-2">
